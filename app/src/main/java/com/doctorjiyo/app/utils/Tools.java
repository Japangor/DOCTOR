...
import com.doctorjiyo.app.model.DeviceInfo;
...
public class Tools {
   ...
   // public static GoogleMap configActivityMaps(GoogleMap googleMap) {
    ...
    public static void rateAction(AppCompatActivity activity) {
    ...
    public static void openInAppBrowser(AppCompatActivity activity, String url, boolean from_notif) {
