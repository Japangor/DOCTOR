package com.doctorjiyo.app.utils;
...
public class ViewAnimation {
    ...
    public static void fadeOutIn(RecyclerView recyclerView) {
        recyclerView.setAlpha(0.f);
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(recyclerView, "alpha", 0.f, 0.5f, 1.f);
        ObjectAnimator.ofFloat(recyclerView, "alpha", 0.f).start();
