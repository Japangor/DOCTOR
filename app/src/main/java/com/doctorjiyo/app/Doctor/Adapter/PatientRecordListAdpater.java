...
import com.doctorjiyo.app.Doctor.Activity.Doctor_MedicalRecords_List_Activity;
import com.doctorjiyo.app.R;

public class PatientRecordListAdpater extends RecyclerView.Adapter<PatientRecordListAdpater.ViewHolder> {

    private Context mContext;
    private List<PatientList> mPatientList;

    public PatientRecordListAdpater(Context mContext, List<PatientList> mPatientList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PatientRecordListAdpater.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext, Doctor_MedicalRecords_List_Activity.class);
