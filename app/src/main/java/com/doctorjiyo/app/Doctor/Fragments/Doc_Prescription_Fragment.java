...
import com.doctorjiyo.app.Doctor.Adapter.PatientListPrescriptionAdpater;
import com.doctorjiyo.app.R;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class Doc_Prescription_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_doc__prescription, container, false);
            ...
            public void onResponse(Call<ArrayList<PatientList>> call, Response<ArrayList<PatientList>> response) {
                if (response.code()==200 ){
                    if (!response.equals(null)){
                        ...
                        PatientListPrescriptionAdpater patientListPrescriptionAdpater =new PatientListPrescriptionAdpater(getContext(),patientLists);
                        recyclerView.setAdapter(patientListPrescriptionAdpater);
                        patientListPrescriptionAdpater.notifyDataSetChanged();
                    }
                }
            }
