...
public class PatientProfileListAdpater extends RecyclerView.Adapter<PatientProfileListAdpater.ViewHolder> {

    private Context mContext;
    private List<PatientList> mPatientList;

    public PatientProfileListAdpater(Context mContext, List<PatientList> mPatientList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PatientProfileListAdpater.ViewHolder(view);
    }
