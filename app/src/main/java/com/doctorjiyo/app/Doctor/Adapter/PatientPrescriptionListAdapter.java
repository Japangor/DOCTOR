...
public class PatientPrescriptionListAdapter extends RecyclerView.Adapter<PatientPrescriptionListAdapter.ViewHolder> {
    ...
    public PatientPrescriptionListAdapter(ArrayList<PrescriptionModel> prescriptionModels, Context context,String patientID) {
