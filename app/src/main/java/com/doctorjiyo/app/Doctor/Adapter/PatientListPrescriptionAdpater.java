...
import com.doctorjiyo.app.Doctor.Activity.Doctor_Prescription_Activity;
import com.doctorjiyo.app.R;

public class PatientListPrescriptionAdpater extends RecyclerView.Adapter<PatientListPrescriptionAdpater.ViewHolder> {

    private Context mContext;
    private List<PatientList> mPatientList;

    public PatientListPrescriptionAdpater(Context mContext, List<PatientList> mPatientList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PatientListPrescriptionAdpater.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext, Doctor_Prescription_Activity.class);
