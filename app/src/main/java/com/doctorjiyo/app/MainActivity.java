...
public class MainActivity extends AppCompatActivity {
    ...
    */
    private int about_images_array[] = {
            R.drawable.img_appointment,
            R.drawable.img_chats,
            R.drawable.img_medicalrecords
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedpreferences.contains(Name)) {
            startActivity(new Intent(getApplicationContext(), Dashboard_Activity.class).putExtra("userid", sharedpreferences.getString(Name, "").trim()));
            finish();
        }
    ...
    private void bottomProgressDots(int current_index) {
        ...
        if (dots.length > 0) {
            ...
            dots[current_index].setColorFilter(getResources().getColor(R.color.green_dark2), PorterDuff.Mode.SRC_IN);
        }
    }
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(final int position) {
            ...
            if (position == about_title_array.length - 1) {
                ...
                btnNext.setBackgroundColor(getResources().getColor(R.color.green_dark2));
