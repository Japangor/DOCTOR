...
public class SlotBookingResult {
    ...
    public SlotBookingResult(String doctorName, String imgPath, String patientName, String contactNumber, String email, String dispensaryName, String bookingFees) {
